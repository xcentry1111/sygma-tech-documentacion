...
build_time_vars = {
    ...
    'BLDSHARED': 'gcc -bundle -undefined dynamic_lookup -L/usr/local/opt/openssl@3/lib -L/usr/local/opt/openssl@3/lib',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '.exe',
    ...
    'CONFIGURE_CPPFLAGS': '-I/usr/local/opt/openssl@3/include',
    'CONFIGURE_LDFLAGS': '-L/usr/local/opt/openssl@3/lib',
    'CONFIGURE_LDFLAGS_NODIST': '',
    'CONFIGURE_LDFLAGS_NOLTO': '',
    'CONFIG_ARGS': "'--with-openssl=/usr/local/opt/openssl@3' 'PKG_CONFIG_PATH=/usr/local/opt/openssl@3/lib/pkgconfig' 'LDFLAGS=-L/usr/local/opt/openssl@3/lib' 'CPPFLAGS=-I/usr/local/opt/openssl@3/include'",
    'CONFINCLUDEDIR': '/usr/local/include',
    'CONFINCLUDEPY': '/usr/local/include/python3.13',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/Users/maximus/Proyectos/ProyectRails/sygma-tech-documentacion/Python-3.13.1/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/Users/maximus/Proyectos/ProyectRails/sygma-tech-documentacion/Python-3.13.1/lcov-report',
    'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage --title "CPython 3.13 LCOV report [commit $(shell )]"',
    'CPPFLAGS': '-I. -I./Include -I/usr/local/opt/openssl@3/include -I/usr/local/opt/openssl@3/include',
    'CXX': 'g++',
    ...
    'JIT_DEPS': '\\',
    'LDCXXSHARED': 'g++ -bundle -undefined dynamic_lookup -L/usr/local/opt/openssl@3/lib -L/usr/local/opt/openssl@3/lib',
    'LDFLAGS': '-L/usr/local/opt/openssl@3/lib -L/usr/local/opt/openssl@3/lib',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'libpython3.13.a',
    'LDLIBRARYDIR': '',
    'LDSHARED': 'gcc -bundle -undefined dynamic_lookup -L/usr/local/opt/openssl@3/lib -L/usr/local/opt/openssl@3/lib',
    'LDVERSION': '3.13',
    'LIBC': '',
    'LIBDEST': '/usr/local/lib/python3.13',
    'LIBDIR': '/usr/local/lib',
    'LIBEXPAT_A': 'Modules/expat/libexpat.a',
    'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/usr/local/opt/openssl@3/include -I/usr/local/opt/openssl@3/include',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    ...
    'LIBMPDEC_CFLAGS': '-I/usr/local/Cellar/mpdecimal/4.0.0/include -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/usr/local/opt/openssl@3/include -I/usr/local/opt/openssl@3/include',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    ...
    'MODULE__DECIMAL_CFLAGS': '-I/usr/local/Cellar/mpdecimal/4.0.0/include',
    'MODULE__DECIMAL_DEPS': './Modules/_decimal/docstrings.h',
    'MODULE__DECIMAL_LDFLAGS': '-L/usr/local/Cellar/mpdecimal/4.0.0/lib -lmpdec -lm',
    ...
    'MODULE__LZMA_CFLAGS': '-I/usr/local/Cellar/xz/5.6.3/include',
    'MODULE__LZMA_LDFLAGS': '-L/usr/local/Cellar/xz/5.6.3/lib -llzma',
    ...
    'PY_CORE_LDFLAGS': '-L/usr/local/opt/openssl@3/lib -L/usr/local/opt/openssl@3/lib',
    'PY_CPPFLAGS': '-I. -I./Include -I/usr/local/opt/openssl@3/include -I/usr/local/opt/openssl@3/include',
    'PY_ENABLE_SHARED': 0,
    'PY_HAVE_PERF_TRAMPOLINE': 0,
    'PY_LDFLAGS': '-L/usr/local/opt/openssl@3/lib -L/usr/local/opt/openssl@3/lib',
    'PY_LDFLAGS_NODIST': '',
    'PY_LDFLAGS_NOLTO': '-L/usr/local/opt/openssl@3/lib -L/usr/local/opt/openssl@3/lib',
    ...
    'abs_builddir': '/Users/maximus/Proyectos/ProyectRails/sygma-tech-documentacion/Python-3.13.1',
    'abs_srcdir': '/Users/maximus/Proyectos/ProyectRails/sygma-tech-documentacion/Python-3.13.1',
